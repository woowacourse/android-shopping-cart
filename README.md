...
- [x] 상품 수량 선택 버튼 추가
- [x] 상품 추가 플로팅 버튼 추가
- [x] 장바구니에서 수량을 변경하는 기능 추가
- [x] 상품 상세에서 수량을 변경하는 기능 추가
- [x] 상품 목록에서 + 버튼을 누르면 수량 변경 뷰가 보이는 기능 추가
- [x] 상품 목록에서 + 버튼을 누르면 장바구니에 반영하는 기능 추가
- [x] 장바구니에서 수량이 변경되면 상품 목록에서 수량을 변경하는 기능 추가
...
## 4단계 기능 목록
- [x] 최근 본 상품이 있을 때, 상품 목록 상단에 최근 본 상품을 10개까지 확인할 수 있다.
- [x] 최근 본 상품을 DB에 저장하는 기능 추가
- [x] 최근 본 상품이 있을 때, 상품 목록 상단에 아이템이 보이는 기능 추가
- [x] 최근 본 상품이 있을 때, 상세 페이지의 하단에 마지막에 본 상품을 보여주는 기능 추가
- [x] 상세 페이지의 하단에서 최근 본 상품을 눌렀을 때, 이전 상세 페이지가 아닌 상품 목록을 보여주는 기능 추가
- [x] HTTP Client 구현
- [x] MockWebServer를 사용한 테스트 추가
