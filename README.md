...
- [ ] 최근 본 상품이 있는 경우 상품 목록 상단에서 10개까지 확인할 수 있다.
  - [ ] 최근 본 상품이 없는 경우 여백을 차지하지 않는다.
- [ ] 상세 페이지에서 마지막으로 본 상품 배너 1개를 확인할 수 있다.
  - [ ] 상세 페이지에서 마지막으로 본 상품 배너를 클릭하면 마지막으로 본 상품 페이지로 이동한다
  - [ ] 마지막으로 본 상품 페이지에서 뒤로 가기를 하면 상품 목록으로 이동한다.
  - [ ] 마지막으로 본 상품 페이지에는 마지막으로 본 상품 배너가 보이지 않는다.
