...
class AppContainer(
    ...
    val productRepository: ProductRepository by lazy {
        ProductRepositoryImpl(
            ProductRemoteDataSourceImpl(client, MockServerManager.getBaseUrl()),
        )
    }
    val cartRepository: CartRepository by lazy {
        CartRepositoryImpl(CartDataSourceImpl(cartItemDao))
    }
    val recentProductRepository: RecentProductRepository by lazy {
        RecentProductRepositoryImpl(RecentProductSourceImpl(recentProductDao))
    }
