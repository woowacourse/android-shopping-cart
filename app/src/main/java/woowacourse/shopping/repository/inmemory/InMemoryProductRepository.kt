...
object InMemoryProductRepository : ProductRepository {
    ...
    val BBOYAMI2 = Product(
        name = "뽀야미2",
        price = Money(11_000),
        imageUrl = "https://i.namu.wiki/i/Fl6hgrl84FWyeRUFM42oScLecflbDFrnMvgNmTo15v7WZpFj_m_EQ7XAK7EX-0G8x7l10E4NqLaTUFL5J6LZCQ.webp"
    )
    val BANILLA2 = Product(
        name = "바닐라2",
        price = Money(12_000),
        imageUrl = "https://i.namu.wiki/i/cjd1kMdYSIteKb_SQyWcrfz6WEEpLQi1RsvUPoEsPxWrVGZKoRBGhBTz0F2y9-6ws0XPD9jQgCfhQgYioHNJrw.webp"
    )
    ...
    val BBOYAMI3 = Product(
        name = "뽀야미3",
        price = Money(11_000),
        imageUrl = "https://i.namu.wiki/i/Fl6hgrl84FWyeRUFM42oScLecflbDFrnMvgNmTo15v7WZpFj_m_EQ7XAK7EX-0G8x7l10E4NqLaTUFL5J6LZCQ.webp"
    )
    val BANILLA3 = Product(
        name = "바닐라3",
        price = Money(12_000),
        imageUrl = "https://i.namu.wiki/i/cjd1kMdYSIteKb_SQyWcrfz6WEEpLQi1RsvUPoEsPxWrVGZKoRBGhBTz0F2y9-6ws0XPD9jQgCfhQgYioHNJrw.webp"
    )
    ...
    val BBOYAMI4 = Product(
        name = "뽀야미4",
        price = Money(11_000),
        imageUrl = "https://i.namu.wiki/i/Fl6hgrl84FWyeRUFM42oScLecflbDFrnMvgNmTo15v7WZpFj_m_EQ7XAK7EX-0G8x7l10E4NqLaTUFL5J6LZCQ.webp"
    )
    val BANILLA4 = Product(
        name = "바닐라4",
        price = Money(12_000),
        imageUrl = "https://i.namu.wiki/i/cjd1kMdYSIteKb_SQyWcrfz6WEEpLQi1RsvUPoEsPxWrVGZKoRBGhBTz0F2y9-6ws0XPD9jQgCfhQgYioHNJrw.webp"
    )
    ...
    override fun getProducts(fromIndex: Int, limit: Int) =
