...
object DummyData {
    ...
    val STUB_PRODUCT_A = Product(id = 1L, name = "홍차", price = 10000, imageUrl = STUB_IMAGE_URL_A)

    const val STUB_IMAGE_URL_B =
        "https://img.danawa.com/prod_img/500000/451/474/img/3474451_1.jpg?_v=20210323160420"
    val STUB_PRODUCT_B = Product(id = 2, name = "스위트 콘", price = 12000, imageUrl = STUB_IMAGE_URL_B)
    ...
    val STUB_PRODUCT_C = Product(id = 3, name = "신라면", price = 15000, imageUrl = STUB_IMAGE_URL_C)
