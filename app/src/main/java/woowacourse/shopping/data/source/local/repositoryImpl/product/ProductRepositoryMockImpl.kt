package woowacourse.shopping.data.source.local.repositoryImpl.product
...
class ProductRepositoryMockImpl : ProductRepository {
    ...
    override suspend fun isProductExist(productId: String): Boolean = MockData.products.any { it.id == productId }
