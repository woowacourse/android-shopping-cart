...
class ShoppingCartViewModel(
    ...
    fun loadAll() {
        _itemsInCurrentPage.value = shoppingProductsRepository.loadProductsInCart(page = currentPage.value ?: currentPageIsNullException())
        _isLastPage.value = shoppingProductsRepository.isCartFinalPage(currentPage.value ?: currentPageIsNullException())
    }
