...
class ShoppingApplication : Application() {
    val productRepository: ProductRepository by lazy { ProductRepositoryImpl.initialize() }
    val cartRepository: CartRepository by lazy { CartRepositoryImpl.initialize(this) }
