...
class ProductDetailActivity : AppCompatActivity(), ProductDetailContract.View {
    ...
    private val selectCountDialog: Dialog by lazy {
        ...
        AlertDialog.Builder(this).apply {
            ...
            selectCountDialogBinding.addToCartBtn.setOnClickListener { presenter.addCartProduct() }
        }.create()
    }
    ...
    override fun setCount(count: Int) { selectCountDialogBinding.counterView.count = count }

    override fun showAccessError() {
        showToast(getString(R.string.error_intent_message))
    }

    override fun showSelectCountDialog() { selectCountDialog.show() }
