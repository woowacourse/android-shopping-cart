...
class DefaultProductHistoryRepositoryStudy(
    private val productHistoryDataSource: ProductHistoryDataSourceStudy,
    private val productDataSource: ProductDataSourceStudy,
) : ProductHistoryRepositoryStudy {
